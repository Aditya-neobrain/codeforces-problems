...
# two integers wi and ci — the mass and the price of the i-th pearl (1 ≤ wi, ci ≤ 1000). It is guaranteed that initially the string 
# is motionless, that is, the hanging part doesn't pull the whole string down.

# Output
# In the first line print two space-separated integers p and s — the number of pearls you can take to get the maximum sum of money, 
# and the sum you can get. In the second line print the string consisting of p characters 'H' or 'T'. 
# If the pearl that is the i-th to take should be taken from the hanging end, then the i-th character of the string must be 'H', 
# otherwise — 'T'. If there are multiple optimal solutions, print any of them.

# If the servant can't take any pearl, just print one line containing two zeroes. 
# You may leave the second line empty or do not print it at all.
